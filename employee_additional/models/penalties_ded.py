...
class PenaltDed(models.Model):
    _name = 'hr.penalt.ded'
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = "misappropriation salary deduction"
    _order = 'id desc'


    @api.model
    def default_get(self, field_list):
        result = super(PenaltDed, self).default_get(field_list)
    ...
    name = fields.Char(string="Deduction Name", default="/", readonly=True, help="Name of the sequantial deduction")
    ...
    payment_date = fields.Date(string="Payment Start Date", required=True, default=fields.Date.today(), help="Date of "
                                                                                                             "the "
                                                                                                             "paymemt")
    loan_lines = fields.One2many('hr.deduction.line', 'loan_id', string="Deduction Line", index=True)
    ...
    job_position = fields.Many2one('hr.job', related="employee_id.job_id", readonly=True, string="Job Position",
                                   help="Job position")
    loan_amount = fields.Float(string="Amount", required=True, help="Deduction amount")
    ...
    # ben added this
    loan_type=fields.Selection([('misappropriation','Misappropriation'),('others','Other')],default='misappropriation',string='Type')
    discription=fields.Char(string='Discription',required=True)
    # ben added this

    @api.model
    def create(self, values):
        values['name'] = self.env['ir.sequence'].get('hr.deduction.seq') or ' '
        res = super(PenaltDed, self).create(values)
        return res
    ...
    def unlink(self):
        ...
        return super(PenaltDed, self).unlink()
...
class InstallmentLine(models.Model):
    ...
    loan_id = fields.Many2one('hr.penalt.ded', string="Loan Ref.", help="Loan")
